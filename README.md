...
For convenience, we provide the final result of this process for all our subjects as `./data.zip`.
...
For convenience, we provide the evaluation results as `./out.zip`. The method to CSV mapping is as follows:
